    ...
    return (
        <>
            <div className='bg-white flex flex-col min-h-screen'>
                <Navbar />
                <ArrowLink href="/balenciagaMuseumProject" width={100} height={100} top={20} left={10} />
                ...
                <div className='flex flex-row mx-8 mt-12 justify-center'>
                    {balenciagaMuseumProjectData.map((item, index) => {
                        if (index !== Number(params.sampleId)) {
                            return (
                                <div key={index} className='w-[28rem] h-auto mr-8'>
                                    <Link href={`/balenciagaMuseumProject/${index}`}>
